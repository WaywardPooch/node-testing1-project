...
class Counter {
  ...
  constructor(initialNumber) {
    ...
    this.currentNumber = initialNumber + 1
  }
...
class Seasons {
  ...
  constructor() {
    // ✨ initialize whatever properties are needed
    this.firstSeason = "spring"
    this.currentSeason = this.firstSeason
  }
  ...
  next() {
    ...
    if (this.currentSeason === "spring") {
      return this.currentSeason = "summer"
    } else if (this.currentSeason === "summer") {
      return this.currentSeason = "fall"
...
class Car {
  ...
  drive(distance) {
    // ✨ implement
    const driveableDistance = this.tank * this.mpg
    if (distance < driveableDistance) {
      this.odometer += distance
      this.tank -= distance / this.mpg
      return { odometer: this.odometer }
    } else {
